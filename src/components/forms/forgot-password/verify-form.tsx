...
export default function CodeVerfiyForm({
    formik,
    onPrevious,
}: {
    onPrevious?: () => void
    ...
    const { resetPasswordParams } = useAuthStore();
    ...
    const sendResetCode = async () => {
        ...
        try {
            const result = await mainClient.post(API_ENDPOINTS.Auth.SendCode, { email: resetPasswordParams.email });
